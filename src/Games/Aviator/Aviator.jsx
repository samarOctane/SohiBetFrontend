        ...
        <div className="MainBox">
            ...
            <div className="AviatorMain">
                ...
                <div className="subAviatorMain" id="subAviatorMain2" >
                    ...
                    <div style={{ width: "100%", height: "70%", border: "1px solid white", borderBottom: "none", display: "flex", flexDirection: "row", borderTopLeftRadius: "12px", borderTopRightRadius: "12px" }}>
                        <div style={{ width: "4vh", height: "100%", border: "1px solid white", borderTop: "none", borderLeft: "none", display: "flex", flexDirection: "column", justifyContent: "space-around", alignItems: "center", borderRight: "1px solid white" }}>
                        ...
                        <div style={{ width: "45%", height: "65%", }} id="planeFly">
                            <div style={{ display: "flex", alignItems: "center", position: "relative", top: "27%" }}>
                                <h1 style={{ fontSize: "4em", color: "white", zIndex: "7", fontSize: "7vh" }}>{waiting ? <WaitProgress /> : multiplier.toFixed(2)}</h1>
                                <h2 style={{ color: "white", fontSize: "6vh", marginTop: "2px", position: "relative", display: waiting ? "none" : "block" }}>X</h2>
                            </div>
                        </div>
                    </div>
                    <div style={{ width: "100%", height: "4vh", border: "1px solid white", display: "flex", justifyContent: "space-around", alignItems: "center", borderTop: "none", borderBottomLeftRadius: "12px", borderBottomRightRadius: "12px", borderTop: "1px solid white" }}>
